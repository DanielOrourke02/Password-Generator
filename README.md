...
- 👨‍💻 All of my projects are available at [https://github.com/DanielOrourke02](https://github.com/DanielOrourke02)
...
> I am very beginner when making GUIs. Im also fairly new to C++ (as of this momment 13/10/23)
 ...
 - clone the repository `git clone https://github.com/DanielOrourke02/Password-Generator` or download the compiled exe (GUI or Terminal)
